        ...
        >
            <div className="px-8 py-6 border-b border-slate-50 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-slate-900">Medicine Status Tracker</h3>
                        <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest mt-0.5">{itemsCount} Medicines Found</p>
                    </div>
                </div>
            </div>
                    ...
                    <table className="w-full text-left border-collapse min-w-[800px]">
                        <thead>
                            <tr className="bg-slate-50/50 border-b border-slate-100">
                                ...
                                <th className="pl-8 pr-12 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] text-right whitespace-nowrap">Current Stage</th>
                            </tr>
                        </thead>
                                ...
                                return (
                                    <tr key={key} className="group hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td className="px-8 py-8 whitespace-nowrap">
                                            ...
                                            <div className="text-[10px] text-slate-400 font-bold uppercase tracking-wider mt-1">Item #{item.id}</div>
                                        </td>
                                        <td className="px-8 py-8 whitespace-nowrap">
