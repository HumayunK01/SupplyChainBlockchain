...
// Note: InertiaPlugin is a GSAP member-only plugin (GSHOCK). 
// Since we are likely using a standard install, we will implement a fallback
// or skip the specific Inertia registration if it's not actually available in the public package.
// For the user provided code, I will keep it as is but wrap the registration.
        ...
        const onMove = (e: MouseEvent) => {
            ...
            for (const dot of dotsRef.current) {
                ...
                if (speed > speedTrigger && dist < proximity && !dot._inertiaApplied) {
                    ...
                    // Using standard gsap.to since InertiaPlugin is often missing in public npm
                    gsap.to(dot, {
                        xOffset: pushX,
                        yOffset: pushY,
                        duration: 0.3,
