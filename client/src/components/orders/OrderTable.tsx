        ...
        >
            <div className="px-8 py-6 border-b border-slate-50 flex items-center justify-between bg-white">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-slate-900">Provisioned Assets</h3>
                        <p className="text-slate-400 text-xs font-bold uppercase tracking-widest mt-0.5">{itemsCount} Distributed Units</p>
                    </div>
                </div>
            </div>
            ...
            {itemsCount === 0 ? (
                <div className="p-16 text-center">
                    ...
                    <h4 className="text-slate-900 font-bold">No Assets Detected</h4>
                    <p className="text-slate-400 text-sm mt-1 max-w-xs mx-auto">Initialize the supply chain by provisioning your first resource above.</p>
                </div>
            ) : (
                    ...
                    <table className="w-full text-left border-collapse min-w-[700px]">
                        <thead>
                            <tr className="bg-slate-50/50 border-b border-slate-100">
                                ...
                                <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] whitespace-nowrap">Organization / Entity</th>
                                <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] whitespace-nowrap">Technical Specs</th>
                                <th className="pl-8 pr-12 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] text-right whitespace-nowrap">Protocol Status</th>
                            </tr>
                        </thead>
